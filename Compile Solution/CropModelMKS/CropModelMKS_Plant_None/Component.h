...
using namespace ATL;
#include "../../../Sources/Components/CropModelMKS.Plant.None/Core.h"
#include <comutil.h>
...
class ATL_NO_VTABLE CComponent :
	...
	public IDispatchImpl<IComponent, &IID_IComponent, &LIBID_CropModelMKSPlantNoneLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
