...
#include "CropModelMKSPlantNone_i.h"
...
typedef struct _CropModelMKSPlantNone_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CropModelMKSPlantNone_MIDL_TYPE_FORMAT_STRING;

typedef struct _CropModelMKSPlantNone_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CropModelMKSPlantNone_MIDL_PROC_FORMAT_STRING;

typedef struct _CropModelMKSPlantNone_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CropModelMKSPlantNone_MIDL_EXPR_FORMAT_STRING;
...
extern const CropModelMKSPlantNone_MIDL_TYPE_FORMAT_STRING CropModelMKSPlantNone__MIDL_TypeFormatString;
extern const CropModelMKSPlantNone_MIDL_PROC_FORMAT_STRING CropModelMKSPlantNone__MIDL_ProcFormatString;
extern const CropModelMKSPlantNone_MIDL_EXPR_FORMAT_STRING CropModelMKSPlantNone__MIDL_ExprFormatString;
...
static const CropModelMKSPlantNone_MIDL_PROC_FORMAT_STRING CropModelMKSPlantNone__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CropModelMKSPlantNone_MIDL_TYPE_FORMAT_STRING CropModelMKSPlantNone__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IComponent, ver. 0.0,
   GUID={0x667732c2,0x14dd,0x4a0a,{0xb8,0x1d,0x4b,0x83,0xac,0x17,0x24,0x34}} */
...
static const MIDL_SYNTAX_INFO IComponentRegistrar_SyntaxInfo [  2 ] = 
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    CropModelMKSPlantNone__MIDL_ProcFormatString.Format,
    &IComponentRegistrar_FormatStringOffsetTable[-3],
    CropModelMKSPlantNone__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    }
...
const CInterfaceProxyVtbl * const _CropModelMKSPlantNone_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _CropModelMKSPlantNone_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentStubVtbl,
    0
...
PCInterfaceName const _CropModelMKSPlantNone_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "IComponent",
    0
...
const IID *  const _CropModelMKSPlantNone_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _CropModelMKSPlantNone_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CropModelMKSPlantNone, pIID, n)

int __stdcall _CropModelMKSPlantNone_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _CropModelMKSPlantNone, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _CropModelMKSPlantNone, 2, *pIndex )
    
}

const ExtendedProxyFileInfo CropModelMKSPlantNone_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CropModelMKSPlantNone_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CropModelMKSPlantNone_StubVtblList,
    (const PCInterfaceName * ) & _CropModelMKSPlantNone_InterfaceNamesList,
    (const IID ** ) & _CropModelMKSPlantNone_BaseIIDList,
    & _CropModelMKSPlantNone_IID_Lookup, 
    2,
    2,
