...
#include <string>
#include <comutil.h>
#include "..\..\..\Sources\Components\CropModelMKS.Climate.Default\Core.h"
...
class ATL_NO_VTABLE CComponent :
	...
	public IDispatchImpl<IComponent, &IID_IComponent, &LIBID_CropModelMKSClimateDefaultLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
