...
module ServerHelper
  ...
  contains
    ...
    function RegisterServer () result (r)
        ...
        bDual = .FALSE.
        bDual = .TRUE.
        status = RegisterClass(Analyzer_PROGID, Analyzer_VERSION, &
                    Analyzer_CLASS_NAME, Analyzer_THREADING_MODEL, &
                    CLSID_Analyzer, GUID_TypeLib_CropModelMKS_Optimization_SCEUA, modname, &
                    bDual)
    ...
    function UnregisterServer () result (r)
        ...
        r = S_OK
        !  Per class
        status = UnregisterClass(Analyzer_PROGID, Analyzer_VERSION, &
                    CLSID_Analyzer)
        ...
        !  is installed
        !status = UnRegisterTypeLib(GUID_TypeLib_CropModelMKS_Optimization_SCEUA, ...)
        !  Remove the \TYPELIB sub-keys
        call COMStringFromGUID(GUID_TypeLib_CropModelMKS_Optimization_SCEUA, TypelibGUID, status)
