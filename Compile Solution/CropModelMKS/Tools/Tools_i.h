...
#ifndef __Tools_i_h__
#define __Tools_i_h__
...
#ifndef __IStatesForPlant_FWD_DEFINED__
#define __IStatesForPlant_FWD_DEFINED__
typedef interface IStatesForPlant IStatesForPlant;

#endif 	/* __IStatesForPlant_FWD_DEFINED__ */
...
#ifndef __StatesForPlant_FWD_DEFINED__
#define __StatesForPlant_FWD_DEFINED__

#ifdef __cplusplus
typedef class StatesForPlant StatesForPlant;
#else
typedef struct StatesForPlant StatesForPlant;
#endif /* __cplusplus */

#endif 	/* __StatesForPlant_FWD_DEFINED__ */
...
#ifndef __IStatesForPlant_INTERFACE_DEFINED__
#define __IStatesForPlant_INTERFACE_DEFINED__

/* interface IStatesForPlant */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IStatesForPlant;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("1b91af26-2115-49e5-9425-054cef06df6e")
    IStatesForPlant : public IDispatch
    {
    public:
    ...
    typedef struct IStatesForPlantVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IStatesForPlant * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
    ...
    interface IStatesForPlant
    {
        CONST_VTBL struct IStatesForPlantVtbl *lpVtbl;
    };
...
#define IStatesForPlant_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IStatesForPlant_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IStatesForPlant_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IStatesForPlant_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IStatesForPlant_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IStatesForPlant_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IStatesForPlant_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IStatesForPlant_Inquire(This,name,value)	\
    ( (This)->lpVtbl -> Inquire(This,name,value) ) 

#define IStatesForPlant_Write(This,name,value)	\
    ( (This)->lpVtbl -> Write(This,name,value) ) 

#define IStatesForPlant_Receive(This,value)	\
...
#endif 	/* __IStatesForPlant_INTERFACE_DEFINED__ */



#ifndef __ToolsLib_LIBRARY_DEFINED__
#define __ToolsLib_LIBRARY_DEFINED__

/* library ToolsLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_ToolsLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("6d2a2d81-cfa2-4af0-87e3-7d35118a64bf")
CompReg;
#endif

EXTERN_C const CLSID CLSID_StatesForPlant;

#ifdef __cplusplus

class DECLSPEC_UUID("ff2d4bd9-6792-447e-bafb-f01b0e3ea744")
StatesForPlant;
#endif
#endif /* __ToolsLib_LIBRARY_DEFINED__ */
