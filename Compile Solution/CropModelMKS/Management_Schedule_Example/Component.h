...
using namespace ATL;
#include <comutil.h>
#include "../../../Sources/Components/Management.Schedule.Example/Core.h"
...
class ATL_NO_VTABLE CComponent :
	...
	public IDispatchImpl<IComponent, &IID_IComponent, &LIBID_ManagementScheduleExampleLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
