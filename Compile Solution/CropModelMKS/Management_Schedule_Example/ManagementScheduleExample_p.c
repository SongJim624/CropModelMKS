...
#include "ManagementScheduleExample_i.h"
...
typedef struct _ManagementScheduleExample_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ManagementScheduleExample_MIDL_TYPE_FORMAT_STRING;

typedef struct _ManagementScheduleExample_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ManagementScheduleExample_MIDL_PROC_FORMAT_STRING;

typedef struct _ManagementScheduleExample_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ManagementScheduleExample_MIDL_EXPR_FORMAT_STRING;
...
extern const ManagementScheduleExample_MIDL_TYPE_FORMAT_STRING ManagementScheduleExample__MIDL_TypeFormatString;
extern const ManagementScheduleExample_MIDL_PROC_FORMAT_STRING ManagementScheduleExample__MIDL_ProcFormatString;
extern const ManagementScheduleExample_MIDL_EXPR_FORMAT_STRING ManagementScheduleExample__MIDL_ExprFormatString;
...
static const ManagementScheduleExample_MIDL_PROC_FORMAT_STRING ManagementScheduleExample__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ManagementScheduleExample_MIDL_TYPE_FORMAT_STRING ManagementScheduleExample__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IComponent, ver. 0.0,
   GUID={0x1fe63ef0,0xa1d3,0x4724,{0xac,0x95,0x29,0x9f,0x35,0xf2,0xa2,0x47}} */
...
static const MIDL_SYNTAX_INFO IComponentRegistrar_SyntaxInfo [  2 ] = 
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ManagementScheduleExample__MIDL_ProcFormatString.Format,
    &IComponentRegistrar_FormatStringOffsetTable[-3],
    ManagementScheduleExample__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    }
...
const CInterfaceProxyVtbl * const _ManagementScheduleExample_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _ManagementScheduleExample_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentStubVtbl,
    0
...
PCInterfaceName const _ManagementScheduleExample_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "IComponent",
    0
...
const IID *  const _ManagementScheduleExample_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _ManagementScheduleExample_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _ManagementScheduleExample, pIID, n)

int __stdcall _ManagementScheduleExample_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _ManagementScheduleExample, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _ManagementScheduleExample, 2, *pIndex )
    
}

const ExtendedProxyFileInfo ManagementScheduleExample_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _ManagementScheduleExample_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ManagementScheduleExample_StubVtblList,
    (const PCInterfaceName * ) & _ManagementScheduleExample_InterfaceNamesList,
    (const IID ** ) & _ManagementScheduleExample_BaseIIDList,
    & _ManagementScheduleExample_IID_Lookup, 
    2,
    2,
