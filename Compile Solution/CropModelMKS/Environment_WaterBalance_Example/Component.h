...
using namespace ATL;
#include "../../../Sources/Components/Environment.WaterBalance.Example/Core.h"
#include <comutil.h>
...
class ATL_NO_VTABLE CComponent :
	...
	public IDispatchImpl<IComponent, &IID_IComponent, &LIBID_EnvironmentWaterBalanceExampleLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CComponent()
	{
