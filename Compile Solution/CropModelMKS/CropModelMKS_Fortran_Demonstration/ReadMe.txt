========================================================================
    Fortran COM Server : "CropModelMKS_Fortran_Demonstration" Project Overview
========================================================================

The Intel Fortran COM Server Application Wizard has created this 
"CropModelMKS_Fortran_Demonstration" project for you as a starting point.

This file contains a summary of what you will find in each of the files 
that make up your project.

CropModelMKS_Fortran_Demonstration.vfproj
...
UComponentTY.f90
    ...
    derived-type, Component_InstanceData.

CropModelMKS_Fortran_Demonstration.hie
...
Edit the CropModelMKS_Fortran_Demonstration.hie file to maintain the definition of your server.
...
save the CropModelMKS_Fortran_Demonstration.hie file, your changes are saved and the project files
are re-generated.
